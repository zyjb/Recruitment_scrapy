...
class QgSpider(scrapy.Spider):
    name = 'wuqg_university'
    start_urls = ['https://www.baidu.com/']  # 对于不方便指定初始地址的，一律设置为百度。
    ...
    def parse(self, response):  # 获取宣讲会url
        url = 'https://whpu.91wllm.com/teachin/index?page={}'
    ...
    def prase_detail(self, response):
        ...
        items['Seminar_college'] = '武汉轻工大学'  # 宣讲会举办学校
