...
#         url_ = 'http://job.hust.edu.cn/searchJob_{}.jspx?type=2&fbsj='
#
#         for i in range(1, 10, 1):
#             url = url_.format(str(i))
#             yield Request(url, callback=self.prase_content, dont_filter=True)
#
